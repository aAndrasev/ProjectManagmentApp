...
namespace ProjectManagmentApp.Infrastucture.Migrations
{
    ...
    [Migration("20240529185413_AddFirstTestEntriesForEntities")]
    partial class AddFirstTestEntriesForEntities
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ProjectManagmentApp.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateOfCreation = new DateTime(2024, 5, 29, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(1953),
                            Description = "Automate household tasks with IoT.",
                            Name = "SmartHome Automation",
                            PlannedEndDate = new DateTime(2024, 6, 28, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(1995),
                            PlannedStartDate = new DateTime(2024, 6, 3, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(1991),
                            StartDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2,
                            DateOfCreation = new DateTime(2024, 5, 29, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(1997),
                            Description = "Monitor fitness goals and progress.",
                            Name = "Health Tracker App",
                            PlannedEndDate = new DateTime(2024, 6, 29, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(1999),
                            PlannedStartDate = new DateTime(2024, 6, 4, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(1997),
                            StartDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3,
                            DateOfCreation = new DateTime(2024, 5, 29, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2001),
                            Description = "Enhance user experience with new features.",
                            Name = "E-commerce Platform Upgrade",
                            PlannedEndDate = new DateTime(2024, 7, 1, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2002),
                            PlannedStartDate = new DateTime(2024, 6, 1, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2001),
                            StartDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 4,
                            DateOfCreation = new DateTime(2024, 5, 29, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2004),
                            Description = "Visualize and analyze large datasets.",
                            Name = "Data Analysis Tool",
                            PlannedEndDate = new DateTime(2024, 6, 26, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2006),
                            PlannedStartDate = new DateTime(2024, 6, 5, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2005),
                            StartDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 5,
                            DateOfCreation = new DateTime(2024, 5, 29, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2007),
                            Description = "Promote renewable energy solutions.",
                            Name = "Green Energy Initiative",
                            PlannedEndDate = new DateTime(2024, 6, 27, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2009),
                            PlannedStartDate = new DateTime(2024, 6, 2, 20, 54, 13, 148, DateTimeKind.Local).AddTicks(2008),
                            StartDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
